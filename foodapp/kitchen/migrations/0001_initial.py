# Generated by Django 5.1.3 on 2025-04-17 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, default=0.0, max_digits=3)),
                ('preparation_time', models.CharField(max_length=20)),
                ('image', models.ImageField(blank=True, null=True, upload_to='thalis/')),
                ('calories', models.PositiveIntegerField(blank=True, null=True)),
                ('is_available', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('kitchen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchen.kitchenprofile')),
                ('toppings', models.ManyToManyField(to='kitchen.topping')),
            ],
        ),
    ]
