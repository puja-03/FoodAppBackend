# Generated by Django 5.1.3 on 2025-03-27 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchen.menu')),
            ],
        ),
        migrations.CreateModel(
            name='Owner',
        ...
        migrations.AddField(
            model_name='kitchen',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchen.owner'),
        ),
    ]
